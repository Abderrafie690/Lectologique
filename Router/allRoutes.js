...
export const allRoutes = [
  ...
  new Route("/allResa", "Vos réservations", "views/reservations/allResa.html", []),
  new Route("/reserver", "réserver", "views/pages/reserver.html", []),
  ...
  new Route("/add-book", "Ajouter un livre", "views/pages/add_book.html", [], "js/auth/add_book.js"),
